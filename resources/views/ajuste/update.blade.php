...
@section('header', 'Personas editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('personas.update',$personas[0]->nro_documento)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="numero" name="numero" required value="{{$personas[0]->nro_documento}}">
                </div>
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" id="nombre" name="nombre" required value="{{$personas[0]->nombre}}">
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="text" id="email" name="email" required value="{{$personas[0]->email}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="tipo de documento">Tipo de documento</label>
                    <select id="tipo de documento" name="tipo_documento" required>
                        <option value="">--Selecciona una opción--</option>
                        @foreach($tipo_documentos as $tipo)
                        @if ($personas[0]->tipo_documento == $tipo->id)
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="apellido" name="apellido" required value="{{$personas[0]->apellido}}">
                </div>
                <div class="form-group">
                    <label for="direccion">Direccion</label>
                    <input type="text" id="direccion" name="direccion" required value="{{$personas[0]->direccion}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="ciudad" name="ciudad" required>
                        ...
                        @if ($personas[0]->ciudad_id == $ciudad->id)
                        <option selected value={{ $ciudad->id }}>{{ $ciudad->descripcion }}</option>
                        @else
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="telefono" name="telefono" required value="{{$personas[0]->telefono}}">
                </div>
                <div class="form-group">
                    <label for="fechan">Fecha de nacimiento</label>
                    <input type="date" id="fechan" name="fecha_nacimiento" required value="{{$personas[0]->fecha_nacimiento}}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('personas.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
