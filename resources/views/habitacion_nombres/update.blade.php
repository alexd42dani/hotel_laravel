...
@section('title','Habitacion_nombres editar')
...
@section('header', 'Habitacion_nombres editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('habitacion_nombres.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('habitacion_nombres.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
