...
@section('title','Habitacion_nombres agregar')
...
@section('header', 'Habitacion_nombres agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('habitacion_nombres.store')}}">
    @csrf
<br>
