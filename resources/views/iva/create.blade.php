...
@section('header', 'Iva agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('iva.store')}}">
    @csrf
<br>
    <div class="container" style="margin-top:30px">
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <input type="text" id="porcentaje" name="porcentaje" required value="0" min="0" max="100">
                </div>
            </div>
        </div>
    </div>
