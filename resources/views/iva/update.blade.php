...
@section('header', 'Iva editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('iva.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
    ...
    <div class="container" style="margin-top:30px">
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <input type="text" id="porcentaje" name="porcentaje" required min="0" max="100" value="{{$variables[0]->porcentaje}}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('iva.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
