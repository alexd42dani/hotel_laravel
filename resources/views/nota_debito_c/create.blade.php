...
@section('title','Nota de debito compra agregar')
...
@section('header', 'Nota de debito compra agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('nota_debito_c.store')}}">
    @csrf
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="form-group my-2 col-md-10">
            <h5>Nota Debito Compra Detalle</h5>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('nota_debito_c.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
