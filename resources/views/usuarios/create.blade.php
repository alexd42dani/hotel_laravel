...
@section('header', 'Usuario agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('usuarios.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="empleado" name="empleado" class="readonly" required autocomplete="off" style="caret-color: transparent !important;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('usuarios.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
