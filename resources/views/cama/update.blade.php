...
@section('header', 'Cama editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('cama.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="capacidad" name="capacidad" min="0" max="10" required value="{{$variables[0]->capacidad}}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" min="0" max="100000000" required value="{{$variables[0]->precio}}">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function mensaje_grabar(){
        ...
        document.querySelector('#capacidad').addEventListener("keypress", function(evt) {
