...
@section('header', 'Cama agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('cama.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="capacidad" name="capacidad" value="0" min="0" max="10" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" value="0" min="0" max="100000000" required>
                </div>
            </div>
        </div>
    </div>
