...
@section('title','Empleado agregar')
...
@section('header', 'Empleado agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('empleado.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="persona" name="persona" class="readonly" required autocomplete="off" style="caret-color: transparent !important;">
                    <input type="hidden" id="persona_ciudad" name="persona_ciudad" value="">
                    <input type="hidden" id="persona_documento" name="persona_documento" value="">
