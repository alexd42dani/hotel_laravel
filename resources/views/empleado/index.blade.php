...
<div class="container" style="margin-top:30px">
    <div class="row">
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$vari->id}}</td>
                            <td>{{$vari->cargo}}</td>
                            <td>{{$vari->codigo_empleado}}</td>
                            <td>{{$vari->nombre}}</td>
                            <td>{{$vari->apellido}}</td>
                            <td>{{$vari->persona_nro_documento}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="col-md-2 form-group mt-5">
            <div class="col-md-12">
                <a class="btn btn-dark form-group" href="{{ route('empleado.create') }}">Agregar</a>
            </div>
            <div class="col-md-12">
                <a id="anular" class="btn btn-dark form-group" onclick="return mensaje_anular()" href="{{ route('empleado.destroy', 'empty') }}">Eliminar</a>
            </div>
            <div class="col-md-12">
                <a id="modificar" class="btn btn-dark form-group" onclick="return mensaje_modificar()" href="{{ route('empleado.edit', 'empty') }}">Modificar</a>
            </div>
        </div>
    </div>
</div>
