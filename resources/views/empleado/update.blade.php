...
@section('header', 'Empleado editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('empleado.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="codigo" name="codigo" value="{{$variables[0]->id}}">
                </div>
                <div class="form-group">
                    <label for="persona">Persona</label>
                    <input type="text" id="persona" name="persona" class="readonly" required autocomplete="off" value="{{$variables[0]->persona_ciudad_id}}-{{$variables[0]->persona_nro_documento}}" style="caret-color: transparent !important;">
                    <input type="hidden" id="persona_ciudad" name="persona_ciudad" value="{{$variables[0]->persona_ciudad_id}}">
                    <input type="hidden" id="persona_documento" name="persona_documento" value="{{$variables[0]->persona_nro_documento}}">
                    <input type="button" value="..." class=" btn-dark" onclick="openWin('persona')">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="cargo" name="cargo" required>
                        ...
                        @if ($variables[0]->cargo_id == $cargo->id)
                        <option selected value={{ $cargo->id }}>{{ $cargo->descripcion }}</option>
                        @else
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="codigo_empleado" name="codigo_empleado" value="{{$variables[0]->codigo_empleado}}" required>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('empleado.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function play() {
        ...
        if (personas != "nothing" && personas != null) {
            ...
            document.getElementById("persona_ciudad").value = personas.split("-")[0];
            document.getElementById("persona_documento").value = personas.split("-")[1];
        }
