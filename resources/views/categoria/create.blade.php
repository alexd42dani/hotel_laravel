...
@section('title','Categoria agregar')
...
@section('header', 'Categoria agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('categoria.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('categoria.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
