...
@section('header', 'Proveedor editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('proveedor.update',$proveedores[0]->ruc)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="ruc" name="ruc" required value="{{$proveedores[0]->ruc}}">
                </div>
                <div class="form-group">
                    <label for="direccion">Direccion</label>
                    <input type="text" id="direccion" name="direccion" required value="{{$proveedores[0]->direccion}}">
                </div>
                <div class="form-group">
                    ...
                    <select id="ciudad" name="ciudad" required>
                        ...
                        @if ($proveedores[0]->ciudad_id == $ciudad->id)
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" required value="{{$proveedores[0]->nombre}}">
                </div>
                <div class="form-group">
                    <label for="telefono">Telefono</label>
                    <input type="text" id="telefono" name="telefono" required value="{{$proveedores[0]->telefono}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="correo">Correo</label>
                    <input type="text" id="correo" name="correo" required value="{{$proveedores[0]->correo}}">
                </div>
                <div class="form-group">
                    <label for="web">Pagina Web</label>
                    <input type="text" id="web" name="web" required value="{{$proveedores[0]->web_page}}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('proveedor.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
