...
@section('title','Departamento agregar')
...
@section('header', 'Departamento agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('departamento.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="pais" name="pais" class="readonly" required autocomplete="off" style="caret-color: transparent !important;">
