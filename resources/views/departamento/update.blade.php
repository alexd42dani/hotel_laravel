...
@section('header', 'Departamento editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('departamento.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="pais" name="pais" value="{{$variables[0]->pais_id}}" class="readonly" required autocomplete="off" style="caret-color: transparent !important;">
                    <input type="button" value="..." class=" btn-dark" onclick="openWin('pais')">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('departamento.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function openWin(w) {
        if (w == "pais") {
            myWindow = window.open("{{ route('searcher.pais') }}", "_blank", "width=1000, height=500, menubar=no, top=50, left=250");
        }
        if (w == "reserva") {
