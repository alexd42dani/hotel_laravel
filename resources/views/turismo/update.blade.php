...
@section('header', 'Turismo editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('turismo.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="direccion" name="direccion" required value="{{$variables[0]->direccion}}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="destino">Destino</label>
                    <input type="text" id="destino" name="destino" required value="{{$variables[0]->destino}}">
                </div>
                <div class="form-group">
                    <label for="precio"> Precio </label>
                    <input type="number" id="precio" name="precio" min="0" max="1000000000" required value="{{$variables[0]->precio}}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('turismo.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
