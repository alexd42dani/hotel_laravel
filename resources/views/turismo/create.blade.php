...
@section('header', 'Turismo agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('turismo.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" min="0" max="1000000000" required>
                </div>
            </div>
        </div>
    </div>
