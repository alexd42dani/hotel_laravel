...
@section('title','Tipo_documento agregar')
...
@section('header', 'Tipo_documento agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('tipo_documento.store')}}">
    @csrf
<br>
