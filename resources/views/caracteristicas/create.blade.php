...
@section('title','Caracteristicas agregar')
...
@section('header', 'Caracteristicas agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('caracteristicas.store')}}">
    @csrf
<br>
