...
@section('title','Habitacion_estado agregar')
...
@section('header', 'Habitacion_estado agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('habitacion_estado.store')}}">
    @csrf
<br>
