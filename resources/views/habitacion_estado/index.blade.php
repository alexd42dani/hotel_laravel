...
@section('title','Habitacion_estado')
...
@section('header', 'Habitacion_estado')
...
<div class="container" style="margin-top:30px">
    <div class="row">
        ...
        <div class="col-md-2 form-group mt-5">
            <div class="col-md-12">
                <a class="btn btn-dark form-group" href="{{ route('habitacion_estado.create') }}">Agregar</a>
            </div>
            <div class="col-md-12">
                <a id="anular" class="btn btn-dark form-group" onclick="return mensaje_anular()" href="{{ route('habitacion_estado.destroy', 'empty') }}">Eliminar</a>
            </div>
            <div class="col-md-12">
                <a id="modificar" class="btn btn-dark form-group" onclick="return mensaje_modificar()" href="{{ route('habitacion_estado.edit', 'empty') }}">Modificar</a>
            </div>
        </div>
    </div>
</div>
