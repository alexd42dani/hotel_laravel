...
@section('header', 'Articulos editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('articulos.update',$articulos[0]->codigo)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="codigo" name="codigo" readonly value="{{$articulos[0]->codigo}}">
                </div>
                <div class="form-group">
                    <label for="stockmm">Stock Minimo</label>
                    <input type="number" id="stockmm" name="stockmm" min="0" max="1000000000" required value="{{$articulos[0]->stock_minimo}}">
                </div>
                <div class="form-group">
                    <label for="uindad">Unidad</label>
                    <select id="unidad" name="unidad" required>
                        <option value="">--Selecciona una opción--</option>
                        @foreach($unidades as $unidad)
                        @if ($articulos[0]->unidad_id == $unidad->id)
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" required value="{{$articulos[0]->nombre}}">
                </div>
                <div class="form-group">
                    <label for="stockmx">Stock Maximo</label>
                    <input type="number" id="stockmx" name="stockmx" min="0" max="1000000000" required value="{{$articulos[0]->stock_maximo}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="descripcion">Descripcion</label>
                    <input type="text" id="descripcion" name="descripcion" required value="{{$articulos[0]->descripcion}}">
                </div>
                <div class="form-group">
                    ...
                    <select id="categoria" name="categoria" required>
                        ...
                        @if ($articulos[0]->categoria_id == $categoria->id)
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('articulos.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
