...
@section('title','Articulos agregar')
...
@section('header', 'Articulos agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('articulos.store')}}">
    @csrf
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stockmm" name="stockmm" value="0" min="0" max="1000000000" required>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stockmx" name="stockmx" value="0" min="0" max="1000000000" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
