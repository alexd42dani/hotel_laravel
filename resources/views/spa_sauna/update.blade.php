...
@section('title','Spa_sauna editar')
...
@section('header', 'Spa_sauna editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('spa_sauna.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" required min="0" max="1000000000" value="{{$variables[0]->precio}}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="descripcion">Descripcion</label>
                    <input type="text" id="descripcion" name="descripcion" required value="{{$variables[0]->nombre}}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('spa_sauna.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
