...
@section('title','Spa_sauna agregar')
...
@section('header', 'Spa_sauna agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('spa_sauna.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" required min="0" max="1000000000">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
