...
@section('title','Operador_turistico agregar')
...
@section('header', 'Operador_turistico agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('operador_turistico.store')}}">
    @csrf
<br>
