...
@section('title','Operador_turistico editar')
...
@section('header', 'Operador_turistico editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('operador_turistico.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('operador_turistico.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
