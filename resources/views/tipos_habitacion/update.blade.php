...
@section('title','Tipos_habitacion editar')
...
@section('header', 'Tipos_habitacion editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('tipos_habitacion.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('tipos_habitacion.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
