...
@section('title','Tipos_habitacion agregar')
...
@section('header', 'Tipos_habitacion agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('tipos_habitacion.store')}}">
    @csrf
<br>
