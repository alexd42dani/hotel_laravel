...
@section('title','Tarifas_nombres agregar')
...
@section('header', 'Tarifas_nombres agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('tarifas_nombres.store')}}">
    @csrf
<br>
