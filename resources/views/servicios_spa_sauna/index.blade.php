...
@section('title','Servicios spa y sauna')
...
@section('header', 'Servicios spa y sauna')
...
<div class="container" style="margin-top:30px">
    ...
    @if (session('error_')!==null)
        ...
        <div class="col-md-2 form-group mt-5">
            <div class="col-md-12">
                <a class="btn btn-dark form-group" href="{{ route('servicios_spa_sauna.create') }}">Agregar</a>
            </div>
            <div class="col-md-12">
                <a id="anular" class="btn btn-dark form-group" onclick="return mensaje_anular()" href="{{ route('servicios_spa_sauna.destroy', 'empty') }}">Anular</a>
            </div>
            <div class="col-md-12">
                <a id="realizado" class="btn btn-dark form-group" onclick="return mensaje_realizado()" href="{{ route('servicios_spa_sauna.realizado', 'empty') }}">Realizado</a>
            </div>
            <div class="col-md-12">
                <a id="modificar" style="display: none;" class="btn btn-dark form-group" onclick="return mensaje_modificar()" href="{{ route('servicios_spa_sauna.edit', 'empty') }}">Modificar</a>
            </div>
        </div>
    </div>
</div>
