...
@section('title','Recaudaciones agregar')
...
@section('header', 'Recaudaciones agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('recaudaciones.store')}}">
    @csrf
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="monto" name="monto" value="0" min="0" max="1000000000" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="tipode"> Tipo deposito </label>
                    <input type="text" id="tipode" name="tipode" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="nubo"> Numero boleta </label>
                    <input type="text" id="nubo" name="nubo" required>
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('recaudaciones.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function mensaje_grabar(){
        ...
        document.querySelector('#monto').addEventListener("keypress", function(evt) {
