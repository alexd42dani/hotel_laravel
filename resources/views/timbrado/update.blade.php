...
@section('header', 'Timbrado editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('timbrado.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="numero" name="numero" required min="0" max="100000000000" value="{{$variables[0]->nro}}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="fecha_desde">Fecha desde</label>
                    <input type="date" id="fecha_desde" name="fecha_desde" required value="{{$variables[0]->fecha_desde}}">
                </div>
                <div class="form-group">
                    <label for="fecha_fin">Fecha fin</label>
                    <input type="date" id="fecha_fin" name="fecha_fin" required value="{{$variables[0]->fecha_fin}}">
                </div>
            </div>
        </div>
    </div>
