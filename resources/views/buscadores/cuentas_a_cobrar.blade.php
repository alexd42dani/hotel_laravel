...
@section('title','Buscador cuentas a cobrar')
...
@section('header', 'Buscador cuentas a cobrar')
            ...
            <div>
                <table id="eventsTable" data-toggle="table" data-height="300" data-pagination="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-classes="table table-bordered table-hover table-md" data-toolbar="#toolbar">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$cuenta->id}}</td>
                            <td>{{$cuenta->nro_cuota}}</td>
                            <td>{{ \Carbon\Carbon::parse($cuenta->fecha_a_pagar)->format('d/m/Y')}}</td>
...
*/
    ...
    function closewin(e) {
        ...
        localStorage.setItem("cuentas_a_cobrar", a);
        localStorage.setItem("cuentas_monto", b);
        this.close();
        //console.log(e);
    }
</script>
