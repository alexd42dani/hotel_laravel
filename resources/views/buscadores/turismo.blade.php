...
@section('title','Buscador turismo')
...
@section('header', 'Buscador turismo')
            ...
            <div>
                <table id="eventsTable" data-toggle="table" data-height="300" data-pagination="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-classes="table table-bordered table-hover table-md" data-toolbar="#toolbar">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$turismo->id}}</td>
                            <td>{{$turismo->destino}}</td>
                            <td>{{$turismo->direccion}}</td>
                            <td>{{number_format($turismo->precio,0,'','.')}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
*/
    ...
    function closewin(e) {
        ...
        localStorage.setItem("turismo", a);
        this.close();
        //console.log(e);
    }
</script>
