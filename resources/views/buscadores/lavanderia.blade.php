...
@section('title','Buscador lavanderia')
...
@section('header', 'Buscador lavanderia')
        ...
        <div class="col-md-10 form-group">
            <div>
                <table id="eventsTable" data-toggle="table" data-height="300" data-pagination="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-classes="table table-bordered table-hover table-md" data-toolbar="#toolbar">
                    ...
                    <tbody>
                        @foreach($lavanderia as $spa)
                        <tr>
                            <td>{{$spa->id}}</td>
                            <td>{{$spa->descripcion}}</td>
                            <td>{{number_format($spa->precio,0,'','.')}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
*/
    ...
    function closewin(e) {
        ...
        localStorage.setItem("lavanderia", a);
        this.close();
        //console.log(e);
    }
</script>
