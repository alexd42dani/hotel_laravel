...
@section('header', 'Cargo editar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('cargo.update',$variables[0]->id)}}">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="departamento" name="departamento" required value="{{$variables[0]->departamento}}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="d-flex flex-wrap justify-content-md-around ">
                        ...
                        <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('cargo.index') }}'" class="btn btn-dark">SALIR</button></div>
                    </div>
                </div>
            </div>
        </div>
