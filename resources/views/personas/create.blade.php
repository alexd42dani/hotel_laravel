...
@section('title','Personas agregar')
...
@section('header', 'Personas agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('personas.store')}}">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="fechan" name="fecha_nacimiento" required>
                </div>
            </div>
        </div>
    </div>
