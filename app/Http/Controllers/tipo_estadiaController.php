...
class tipo_estadiaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $tipo_estadia = DB::table('tipo_estadia')
            ->select(
                'tipo_estadia.*'
            )
            ->get();
        ...
        return view('tipo_estadia.index', ['variables' => $tipo_estadia]);
    }
    ...
    public function create()
    {
        ...
        return view('tipo_estadia.create'
        /* ,[
            'ciudades' => $ciudad,
        ]*/
    );
    ...
    {
        // dump(request()->all());
          DB::table('tipo_estadia')->insert(
            [
                'descripcion' => request()->descripcion
            ]
        );
       
        return redirect()->route('tipo_estadia.index');
    }
    ...
    public function edit($id)
    {
       // $ciudad = DB::table('ciudad')->get();
        ...
        //dd($reservas);
        return view('tipo_estadia.update', [
            'variables' => $tipo_estadia
        ]);
    }
    ...
    {
        DB::table('tipo_estadia')->where('id', '=', $id)->delete();
