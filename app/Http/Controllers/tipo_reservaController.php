...
class tipo_reservaController extends Controller
{
    ...
    public function index()
    {
        ...
        $tipo_reserva = DB::table('tipo_reserva')
            ->select(
                'tipo_reserva.*'
            )
            ->get();
        ...
        return view('tipo_reserva.index', ['variables' => $tipo_reserva]);
    }
    ...
    public function create()
    {
        ...
        return view('tipo_reserva.create'
        /* ,[
            'ciudades' => $ciudad,
        ]*/
    );
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tipo_reserva.index');
    }
    ...
    public function edit($id)
    {
       // $ciudad = DB::table('ciudad')->get();
        ...
        //dd($reservas);
        return view('tipo_reserva.update', [
            'variables' => $tipo_reserva
        ]);
    }
    ...
    {
        DB::table('tipo_reserva')->where('id', '=', $id)->delete();
