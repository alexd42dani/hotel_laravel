...
class operador_turisticoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $operador_turistico = DB::table('operador_turistico')
            ->select(
                'operador_turistico.*'
            )
            ->get();
        ...
        return view('operador_turistico.index', ['variables' => $operador_turistico]);
    }
    ...
    public function create()
    {
        ...
        return view('operador_turistico.create'
        /* ,[
            'ciudades' => $ciudad,
        ]*/
    );
    ...
    {
        // dump(request()->all());
          DB::table('operador_turistico')->insert(
            [
                'descripcion' => request()->descripcion
            ]
        );
       
        return redirect()->route('operador_turistico.index');
    }
    ...
    public function edit($id)
    {
       // $ciudad = DB::table('ciudad')->get();
        ...
        //dd($reservas);
        return view('operador_turistico.update', [
            'variables' => $operador_turistico
        ]);
    }
    ...
    {
        DB::table('operador_turistico')->where('id', '=', $id)->delete();
