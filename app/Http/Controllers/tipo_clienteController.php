...
class tipo_clienteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tipo_cliente.index', ['variables' => $tipo_cliente]);
    }
    ...
    public function create()
    {
        ...
        return view('tipo_cliente.create'
        /* ,[
            'ciudades' => $ciudad,
        ]*/
    );
    ...
    public function edit($id)
    {
       // $ciudad = DB::table('ciudad')->get();
        ...
        //dd($reservas);
        return view('tipo_cliente.update', [
            'variables' => $tipo_cliente
        ]);
    }
    ...
    {
        DB::table('tipo_cliente')->where('id', '=', $id)->delete();
