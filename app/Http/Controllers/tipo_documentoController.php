...
class tipo_documentoController extends Controller
{
    ...
    public function index()
    {
        ...
        $tipo_documento = DB::table('tipo_documento')
            ->select(
                'tipo_documento.*'
            )
            ->get();
        ...
        return view('tipo_documento.index', ['variables' => $tipo_documento]);
    }
    ...
    public function edit($id)
    {
       // $ciudad = DB::table('ciudad')->get();
        ...
        //dd($reservas);
        return view('tipo_documento.update', [
            'variables' => $tipo_documento
        ]);
    }
